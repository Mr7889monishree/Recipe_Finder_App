...
import type { InternalTheme } from '@clerk/clerk-js/dist/types/ui/styledSystem';
...
type PublicAppearanceTopLevelKey = keyof Omit<Appearance, 'baseTheme' | 'elements' | 'layout' | 'variables' | 'captcha' | 'cssLayerName'>;
